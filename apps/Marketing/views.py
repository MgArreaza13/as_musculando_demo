...
from apps.Marketing.serializers import MailSerializer



def get_mails(self):
	return HttpResponse(serializers.serialize('json', tb_mail.objects.all(), fields=('user','Asunto', 'Mailbody' , 'dateCreate')) )
